...
!added by xsz: we make these 4+4 data public for the vmix acc accelaration
   public :: AU0, AUN, AUE, AUNE, AT0,ATS,ATW,ATSW
...
!-----------------------------------------------------------------------
   ...
   if (latlon_only) then
      ...
      if (my_task == master_task) then
        ! added by conghui
       write(stdout,*)'conghui: file=',horiz_grid_file
