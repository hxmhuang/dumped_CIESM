...
!untested    !$OMP                     CFC11SAT_USED,PV,FLUX)
    ...
    !---------------------------------------------------------------------------
       ...
       call SCHMIDT_CFC(SST(:,:,iblock), LAND_MASK(:,:,iblock), 11,SCHMIDT_USED )
       call SOLUBILITY_CFC_nyf(SST(:,:,iblock),  &
                         SSS(:,:,iblock),   &
                         LAND_MASK(:,:,iblock), 11, CFC11SAT_1atm_nyf )


       CFC11SAT_1atm = pCFC11(:,:,iblock)*  CFC11SAT_1atm_nyf
...
subroutine SCHMIDT_CFC_nyf(PT_2D,LAND_MASK,kn,SCHMIDT_CFC)
...
!EOC
 ...
 end subroutine SCHMIDT_CFC_nyf
...
! !INTERFACE:
 ...
 subroutine SOLUBILITY_CFC_nyf(PT,PS,LAND_MASK,kn,SOLUBILITY_CFC)
...
!EOC
 ...
 end subroutine SOLUBILITY_CFC_nyf
