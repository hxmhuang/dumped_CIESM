...
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/drv/seq_mct/release_tags/cesm1_2_x_n01_drvseq4_2_34/driver/seq_hist_mod.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
subroutine seq_hist_writeavg(EClock_d,write_now)
   ...
   type(mct_aVect),save  :: xao_ox_avg(num_inst_ocn)
