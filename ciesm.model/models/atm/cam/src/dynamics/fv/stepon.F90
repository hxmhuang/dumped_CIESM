...
! !USES:
   ...
   use commap,             only: w
   use fv_control_mod,     only: oro_drag
...
!$omp parallel do private(i,j,k)
   ...
   if( oro_drag ) then
      call zm_calculate( 1, ifirstxy, ilastxy, jfirstxy, jlastxy, 1, km, dyn_in%pe, dyn_in%pt, dyn_in%zm )
!          call orography_drag(ifirstxy, ilastxy, jfirstxy, jlastxy, 1, km, dyn_in%zm, dyn_in%sgh, dyn_in%u3s, dyn_in%v3s, dtime/8.0 )
          call orography_drag(ifirstxy, ilastxy, jfirstxy, jlastxy, 1, km, dyn_in%zm, dyn_in%sgh, dyn_in%u3s, dyn_in%v3s, dtime/8.0, &
                              dyn_in%pe, dyn_in%t3 )
   endif
!EOC
