...
#endif
     !yj-pio
     ierr=pio_put_att (tape(t)%File, PIO_GLOBAL, 'case',"none")
     ierr=pio_put_att (tape(t)%File, PIO_GLOBAL, 'title',ctitle)
     ierr=pio_put_att (tape(t)%File, PIO_GLOBAL, 'logname',"none")
     ierr=pio_put_att (tape(t)%File, PIO_GLOBAL, 'host', "none")
