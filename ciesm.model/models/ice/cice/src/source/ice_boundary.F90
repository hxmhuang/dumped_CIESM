...
!-----------------------------------------------------------------------
   ...
   integer (int_kind), save, dimension(:), allocatable :: &
      sndRequest,      &! MPI request ids
      rcvRequest        ! MPI request ids
   ...
   real (dbl_kind), save, dimension(:,:), allocatable :: &
      bufSend, bufRecv            ! 3d send,recv buffers

   real (dbl_kind), save, dimension(:,:,:), allocatable :: &
      bufTripole                  ! 3d tripole buffer

   integer (int_kind),save :: len ! length of message 
   logical,save :: do_send, do_recv
   !save
