...
!                             field_loc_center, field_type_scalar, field_type_vector, c100
                              field_loc_center, field_type_scalar, field_type_vector, c100, depressT
!---------------liangys 2016-08-27 ice freeze-------------------
...
!---------------liangys 2016-09-05 ice freeze-------------------
    use ice_init, only: tfreez_salt_ice 
!---------------liangys 2016-09-05 ice freeze-------------------
...
!          Tf (i,j,iblk) = -1.8_dbl_kind                 ! hardwired for NCOM
          if (tfreez_salt_ice) then
             if ( Tfrzpt == 'constant') then
                  Tf (i,j,iblk) = -1.8_dbl_kind                 ! hardwired for NCOM
