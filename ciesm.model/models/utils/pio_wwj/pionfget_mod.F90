...
!<
  public :: get_var
# 56 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/pionfget_mod.F90.in"
  interface get_var
...
# 65 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/pionfget_mod.F90.in"
CONTAINS
...
!<
# 78 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/pionfget_mod.F90.in"
...
!>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>wwj
       ...
       !   write(1024, *) __FILE__, __LINE__, "cfio_begin_indep_data not defined in cfio! " 
       !   close(1024)
...
#ifdef CFIO_DEBUG
        !  open(unit = 1024, status = 'unknown', access = 'append', file = 'cfio_pio_log')
        !  write(1024, *) __FILE__, __LINE__, "cfio_get_vara_text not defined in cfio! " 
        !  close(1024)
          if (File%iosystem%io_rank == 0) then
        print *,__FILE__,__LINE__,"[CFIO DEBUG]: cfio_get_vara_{TYPR} not defined"
          endif
#endif
             ierr = nfmpi_get_vara_text (File%fh, varid, int(index,kind=PIO_OFFSET), kount(1:sofindex), ival)
...
#ifdef CFIO_DEBUG
          if (File%iosystem%io_rank == 0) then
            print *,__FILE__,__LINE__,"[CFIO DEBUG]: nfmpi_get_vara_ over", ierr
          endif
#endif
       ...
       !   close(1024)
          if (File%iosystem%io_rank == 0) then
        print *,__FILE__,__LINE__,"[CFIO DEBUG]: cfio_get_vara_text not defined"
          endif
#endif
             ierr = nfmpi_get_var1_text (File%fh, varid, int(index,kind=PIO_OFFSET), ival)
...
#ifdef CFIO_DEBUG
          if (File%iosystem%io_rank == 0) then
            print *,__FILE__,__LINE__,"[CFIO DEBUG]: nfmpi_get_var1_ over", ierr
          endif
#endif
...
!>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>wwj
...
#ifdef CFIO_DEBUG
        !  open(unit = 1024, status = 'unknown', access = 'append', file = 'cfio_pio_log')
        !  write(1024, *) __FILE__, __LINE__, "cfio_get_vara_real not defined in cfio! " 
        !  close(1024)
          if (File%iosystem%io_rank == 0) then
        print *,__FILE__,__LINE__,"[CFIO DEBUG]: cfio_get_vara_{TYPR} not defined"
          endif
       ...
       !   close(1024)
          if (File%iosystem%io_rank == 0) then
        print *,__FILE__,__LINE__,"[CFIO DEBUG]: cfio_get_vara_real not defined"
          endif
#endif
             ierr = nfmpi_get_var1_real (File%fh, varid, int(index,kind=PIO_OFFSET), ival)
...
!>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>wwj
...
#ifdef CFIO_DEBUG
        !  open(unit = 1024, status = 'unknown', access = 'append', file = 'cfio_pio_log')
        !  write(1024, *) __FILE__, __LINE__, "cfio_get_vara_double not defined in cfio! " 
        !  close(1024)
          if (File%iosystem%io_rank == 0) then
        print *,__FILE__,__LINE__,"[CFIO DEBUG]: cfio_get_vara_{TYPR} not defined"
          endif
       ...
       !   close(1024)
          if (File%iosystem%io_rank == 0) then
        print *,__FILE__,__LINE__,"[CFIO DEBUG]: cfio_get_vara_double not defined"
          endif
#endif
             ierr = nfmpi_get_var1_double (File%fh, varid, int(index,kind=PIO_OFFSET), ival)
...
!>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>wwj
...
#ifdef CFIO_DEBUG
        !  open(unit = 1024, status = 'unknown', access = 'append', file = 'cfio_pio_log')
        !  write(1024, *) __FILE__, __LINE__, "cfio_get_vara_int not defined in cfio! " 
        !  close(1024)
          if (File%iosystem%io_rank == 0) then
        print *,__FILE__,__LINE__,"[CFIO DEBUG]: cfio_get_vara_{TYPR} not defined"
          endif
       ...
       !   close(1024)
          if (File%iosystem%io_rank == 0) then
        print *,__FILE__,__LINE__,"[CFIO DEBUG]: cfio_get_vara_int not defined"
          endif
#endif
             ierr = nfmpi_get_var1_int (File%fh, varid, int(index,kind=PIO_OFFSET), ival)
...
!! @retval ierr @ref error_return
!<
# 259 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/pionfget_mod.F90.in"
...
# 297 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/pionfget_mod.F90.in"
!! Note: setting any element of the count array to zero causes the function to exit without error, and without doing anything. 
!! @param ival : The value for the netcdf metadata
!! @retval ierr @ref error_return
!<
# 301 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/pionfget_mod.F90.in"
...
#ifdef CFIO_DEBUG
       !   open(unit = 1024, status = 'unknown', access = 'append', file = 'cfio_pio_log')
       !   write(1024, *) __FILE__, __LINE__, "cfio_get_vara_all not defined in cfio! " 
       !   close(1024)
          if (File%iosystem%io_rank == 0) then
        print *,__FILE__,__LINE__,"[CFIO DEBUG]: cfio_get_vara_all not defined"
          endif
#endif
          ierr = nfmpi_get_vara_all (File%fh, varid, int(start,kind=PIO_OFFSET), &
               int(count,kind=PIO_OFFSET), ival, isize, MPI_CHARACTER)
...
#ifdef CFIO_DEBUG
          if (File%iosystem%io_rank == 0) then
            print *,__FILE__,__LINE__,"[CFIO DEBUG]: nfmpi_get_vara_all over", ierr
          endif
#endif
...
!!   variable, the first element of count corresponds to a count of the
!!   number of records to read.
# 439 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/pionfget_mod.F90.in"
!! Note: setting any element of the count array to zero causes the function to exit without error, and without doing anything. 
!! @param ival : The value for the netcdf metadata
!! @retval ierr @ref error_return
!<
# 443 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/pionfget_mod.F90.in"
...
!! @retval ierr @ref error_return
!<
# 465 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/pionfget_mod.F90.in"
...
#ifdef CFIO_DEBUG
       !   open(unit = 1024, status = 'unknown', access = 'append', file = 'cfio_pio_log')
       !   write(1024, *) __FILE__, __LINE__, "cfio_get_var_all not defined in cfio! " 
       !   close(1024)
          if (File%iosystem%io_rank == 0) then
        print *,__FILE__,__LINE__,"[CFIO DEBUG]: cfio_get_var_all not defined"
          endif
#endif
          ierr = nfmpi_get_var_all(File%fh, varid, ival, isize, MPI_CHARACTER)
...
#ifdef CFIO_DEBUG
          if (File%iosystem%io_rank == 0) then
            print *,__FILE__,__LINE__,"[CFIO DEBUG]: nfmpi_get_var_all over", ierr
          endif
#endif
...
!! @retval ierr @ref error_return
!<
# 579 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/pionfget_mod.F90.in"
