...
!<
# 57 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
# 66 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
!! @brief The overloaded PIO_read_darray function reads a distributed array from disk.
!<
# 68 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
!! @private
!<
# 77 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
#ifdef _COMPRESSION
# 83 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
  interface 
# 84 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
# 92 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
  interface
# 93 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
# 111 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
contains

# 113 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
!<  
# 136 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
!! @param fillval : An optional fill value to fill holes in the data written
!<  
# 242 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
! This code is required due to a bug in gfortran 4.7.2
    ...
    return
#else
# 278 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
!! @param iostat : The status returned from this routine (see \ref PIO_seterrorhandling for details)
!<
# 301 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
!! @param iostat : The status returned from this routine (see \ref PIO_seterrorhandling for details)
!<
# 382 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
!! @param fillval : An optional fill value to fill holes in the data written
!<
# 419 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
!       end if
       !>>>>>>>>>>>>>>>>>>>>>>>>>>>>wwj
       if(file%iotype==pio_iotype_pnetcdf .or. file%iotype==pio_iotype_cfio) then
          allocate(iobuf(size(array)))
          iobuf=array
       else
          iobuf=>array
...
!       end if
       ...
       if(file%iotype==pio_iotype_pnetcdf .or. file%iotype==pio_iotype_cfio) then
          call add_data_to_buffer(File, IOBUF, request)
!#ifdef CFIO_DEBUG
!        print *,__FILE__,__LINE__,"[wwj]: write_darry_nf_real call add_data_to"
!#endif
       else if(Userearranger) then
          deallocate(iobuf)
       end if
...
!       end if
       ...
       if(file%iotype==pio_iotype_pnetcdf .or. file%iotype==pio_iotype_cfio) then
          call add_data_to_buffer(File, IOBUF, request)
!#ifdef CFIO_DEBUG
!        print *,__FILE__,__LINE__,"[wwj]: write_darry_nf_int call add_data_to"
!#endif
       else if(Userearranger) then
          deallocate(iobuf)
       end if
...
!       end if
       ...
       if(file%iotype==pio_iotype_pnetcdf .or. file%iotype==pio_iotype_cfio) then
          call add_data_to_buffer(File, IOBUF, request)
!#ifdef CFIO_DEBUG
!        print *,__FILE__,__LINE__,"[wwj]: write_darry_nf_double call add_data_to"
!#endif
       else if(Userearranger) then
          deallocate(iobuf)
       end if
...
!! @param fillval : An optional fill value to fill holes in the data written
!<  
# 679 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
!! @param iostat : The status returned from this routine (see \ref PIO_seterrorhandling for details)
!<
# 864 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
!! @param iostat : The status returned from this routine (see \ref PIO_seterrorhandling for details)
!<
# 1054 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
!!!!!!! end debug
  ...
  ! TYPE real,int,double  
# 1212 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
# 1252 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
!>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>wwj
       ...
       !   write(1024, *) __FILE__, __LINE__, "cfio_wait_all not defined in cfio! " 
       !   close(1024)
          if (File%iosystem%io_rank == 0) then
        print *,__FILE__,__LINE__,"[CFIO DEBUG]: cfio_wait_all not defined"
          endif
#endif
       ierr  = nfmpi_wait_all(file%fh, file%request_cnt, array_of_requests, status)
...
#ifdef CFIO_DEBUG
          if (File%iosystem%io_rank == 0) then
            print *,__FILE__,__LINE__,"[CFIO DEBUG]: nfmpi_wait_all over", ierr
          endif
#endif
...
# 1351 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
...
# 1463 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/piodarray.F90.in"
