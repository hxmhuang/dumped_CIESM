...
!<
  public :: read_nf
# 20 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/pionfread_mod.F90.in"
  interface read_nf
...
# 27 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/pionfread_mod.F90.in"
contains
...
!! @private
!<
# 33 "/home/export/online1/qhtest/swqh/USER-TSINGHUA/wwj/cesm0920/models/utils/pio/pionfread_mod.F90.in"
...
!>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> zc
       ...
       case(pio_iotype_cfio)
           ...
           !write(1024,*) __FILE__, __LINE__, "nfmpi_get_vara_all - not defined in CFIO!"
           !close(1024)
           if (File%iosystem%io_rank == 0) then
              print *, __FILE__, __LINE__, "[CFIO DEBUG]: nfmpi_get_vara_all - not defined in CFIO!"
           endif
#endif
          ...
          ierr=nfmpi_get_vara_all( File%fh,varDesc%varid, &
           ...
           !endif
           print *, "[CFIO DEBUG]: nfmpi_get_vara_all over", varDesc%varid, File%iosystem%io_rank, ierr
#endif
#endif
!<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< zc
