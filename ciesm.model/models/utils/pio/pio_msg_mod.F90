...
!xuz    if(debugasync) print *,__FILE__,__LINE__,&
!     &index,list_item%iodesc%async_id
    if(debugasync) print *,__FILE__,__LINE__,index,&
     &     list_item%iodesc%async_id
...
!xuz       if(debugasync) print *,__FILE__,__LINE__,list_item%index,async_id,list_item%iodesc%async_id
       if(debugasync) print *,__FILE__,__LINE__,&
     &    list_item%index,async_id,list_item%iodesc%async_id
       if(abs(list_item%iodesc%async_id) == async_id) then
          iodesc => list_item%iodesc
!xuz          if(debugasync) print *,__FILE__,__LINE__,async_id,list_item%index,iodesc%write%n_elemtype
          if(debugasync) print *,__FILE__,__LINE__,&
     &      async_id,list_item%index,iodesc%write%n_elemtype
          exit
       end if
       list_item=>list_item%next
    end do
