...
!-------------liangys 2016-08-27 for ice freeze tempature---------------
   logical (log_kind), public :: &
      tfreez_salt         ! T ==> sea ice freeze tempature if the function of
                          ! salt: T = -0.054 * salt 
                          ! F ==> sea ice freeze tempature is constant : -1.8 
!-------------liangys 2016-08-27 for ice freeze tempature---------------
...
!   namelist /ice_nml/ kmxice, ice_freq_opt, ice_freq, lactive_ice
   namelist /ice_nml/ kmxice, ice_freq_opt, ice_freq, lactive_ice, tfreez_salt
!-------------liangys 2016-08-27 for ice freeze tempature---------------
...
!-------------liangys 2016-08-27 for ice freeze tempature---------------
   call broadcast_scalar(tfreez_salt,   master_task)
!-------------liangys 2016-08-27 for ice freeze tempature---------------
...
!   TFRZ = -1.8_r8
   if ( tfreez_salt ) then
      TFRZ = -0.054_r8*SALT*salt_to_ppt
   else
      TFRZ = -1.8_r8
   endif
!-------------liangys 2016-08-27 for ice freeze tempature---------------
