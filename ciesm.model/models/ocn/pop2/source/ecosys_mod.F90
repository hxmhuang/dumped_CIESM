...
!-----------------------------------------------------------------------
         ...
         if (lflux_gas_o2) then
            call SCHMIDT_O2(SST(:,:,iblock), LAND_MASK(:,:,iblock),SCHMIDT_USED)
...
!-----------------------------------------------------------------------
         ...
         if (lflux_gas_co2) then
            ...
            call SCHMIDT_CO2(SST(:,:,iblock), LAND_MASK(:,:,iblock),SCHMIDT_USED)
...
subroutine SCHMIDT_O2(SST, LAND_MASK,SCHMIDT_O2_nyf)
...
! !OUTPUT PARAMETERS:
   ...
   real (r8), dimension(nx_block,ny_block) ,intent(inout):: SCHMIDT_O2_nyf
...
!-----------------------------------------------------------------------
   ...
   do j=1,ny_block
     do i=1,nx_block
        if(LAND_MASK(i,j) .eq. .TRUE.) then 
         SCHMIDT_O2_nyf(i,j)= a + SST(i,j) * (-b + SST(i,j) * (c + SST(i,j) * (-d)))
        else
         SCHMIDT_O2_nyf(i,j) = c0
        endif
     enddo 
   enddo
...
subroutine SCHMIDT_CO2(SST, LAND_MASK,SCHMIDT_CO2_nyf)
...
! !OUTPUT PARAMETERS:
   ...
   real (r8), dimension(nx_block,ny_block) ,intent(inout):: SCHMIDT_CO2_nyf
...
!-----------------------------------------------------------------------
   ...
   do j=1,ny_block
     do i=1,nx_block
        if(LAND_MASK(i,j) .eq. .TRUE.) then 
         SCHMIDT_CO2_nyf(i,j) = a + SST(i,j) * (-b + SST(i,j) * (c + SST(i,j) * (-d)))
        else
         SCHMIDT_CO2_nyf(i,j) = c0
        endif
     enddo 
   enddo
