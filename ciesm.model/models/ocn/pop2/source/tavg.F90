...
!   save
   ...
   logical (log_kind), dimension(max_avail_tavg_streams) ,save::    &
   ...
   integer (int_kind), dimension(max_avail_tavg_streams) ,save::    &
   ...
   character (char_len),dimension(:),allocatable ,save::  &
    ...
    if (ifield > 0 ) then
      ...
      if (loc > 0) then
        ...
        if (loc > 0 ) then
          ...
          !yj-pio
          call add_attrib_file(tavg_file_desc, 'start_time', "none")
