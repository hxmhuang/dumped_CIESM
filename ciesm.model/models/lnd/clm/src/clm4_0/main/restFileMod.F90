...
!------------------------------------------------------------------------
    ...
    ! yj-pio
    call ncd_putatt(ncid, NCD_GLOBAL, 'history' , "none")
    call ncd_putatt(ncid, NCD_GLOBAL, 'username', "none")
    call ncd_putatt(ncid, NCD_GLOBAL, 'host'    , "none")
    ...
    call ncd_putatt(ncid, NCD_GLOBAL, 'case_id'        , "none")
