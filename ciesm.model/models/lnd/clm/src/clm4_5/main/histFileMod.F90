...
!-----------------------------------------------------------------------
    ...
    ! yj-pio
    call ncd_putatt(lnfid, ncd_global, 'history' , "none")
    call ncd_putatt(lnfid, ncd_global, 'source'  , trim(source))
    call ncd_putatt(lnfid, ncd_global, 'hostname', "none")
    call ncd_putatt(lnfid, ncd_global, 'username', "none")
    ...
    call ncd_putatt(lnfid, ncd_global, 'case_id', "none")
