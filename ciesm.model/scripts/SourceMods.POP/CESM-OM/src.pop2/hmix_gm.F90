...
!      integer :: myyj(nx_block,ny_block)
...
!yj
!      myyj = 0
!      write(stdout,*) ' I am yj,1'
!      where (KMT(:,:,bid) == 0 ) 
!	  myyj = 1
!	  endwhere
!
!      if ( any(myyj == 1) ) then 
!        write(stdout,*) ' I am yj,kmt(::,bid)==0'
!      endif
!      
!	  
!	  where (K_START > KMT(:,:,bid)  ) 
!	  myyj=2
!	  endwhere
!      if ( any(myyj == 2) ) then 
!        write(stdout,*) ' I am yj,kstart > kmt'
!      endif
!
!      where (K_START == KMT(:,:,bid)  ) 
!	  myyj=3
...
!
      ...
      enddo
!yj
!      write(stdout,*) 'nx_block,ny_block',nx_block,ny_block
#ifdef CCSMCOUPLED
#ifndef _HIRES
!yj
      do i=1,nx_block
	      do j=1,ny_block
        if ( COMPUTE_TLT(i,j) == .true. ) then
		 write(stdout,*) ' I am true,nx,ny,bid',i,j,bid,TLAT(i,j,bid),TLON(i,j,bid)
		endif
	  end do
	  end do
!yj	  
