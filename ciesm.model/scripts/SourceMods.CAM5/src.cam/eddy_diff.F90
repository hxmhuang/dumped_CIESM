  ...
  real(r8),         parameter :: cleng          =  3._r8        !  Order of '&
...
! qinyi 2016-5-27 10:23:12
    call addfld('LK',          'm',     pver+1, 'A',  'lk, I',                            phys_decomp )
...
! qinyi
    real(r8), intent(out)   :: shi(pcols,pver+1)         ! Galperin instability function of heat-moisture at all interfaces
    real(r8), intent(out)   :: smi(pcols,pver+1)         ! Galperin instability function of heat-moisture at all interfaces
...
!qinyi 2016-5-27 10:25:12
   real(r8) :: lk(pcols,pver+1)
...
! qinyi 2016-5-27 10:24:11
    call outfld( 'LK',        lk,      pcols,   lchnk )
