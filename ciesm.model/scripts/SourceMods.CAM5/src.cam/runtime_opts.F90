...
!=======================================================================
  ...
  subroutine read_namelist(single_column_in, scmlon_in, scmlat_in, nlfilename_in )
   ...
   use prescribed_volc_rad, only: prescribed_volc_rad_readnl !wmq
   ...
   use dim_readnl,          only: dim_intr_readnl !wmq
...
!
   ...
   call prescribed_volc_rad_readnl(nlfilename) !wmq
