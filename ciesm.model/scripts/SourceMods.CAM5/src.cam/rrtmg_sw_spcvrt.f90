...
! ----------------------ZWJ--------------------------------------------------
                ...
                ztauc(jk) = (1.0_r8 - zwf) * ztauc(jk)
                zomcc(jk) = (zomcc(jk) - zwf) / (1.0_r8 - zwf)
                omegac1(jk) = 3.0*(zgcc(jk)-zf)/(1.0_r8-zf)
                omegac2(jk) = 5.0*(zgcc(jk)**2.0-zf)/(1.0_r8-zf)
                omegac3(jk) = 7.0*(zgcc(jk)**3.0-zf)/(1.0_r8-zf)
                zgcc (jk) = (zgcc(jk) - zf) / (1.0_r8 - zf)
               endif
! ----------------------ZWJ---------------------------------------------------
! ----------------------------------------------------------------------------
...
! -----------------------------------ZWJ-----------------------------------------------
                  if (kmodts == 4) then
                   omegao1(jk) = 3.0*zgco(jk)
                   omegao2(jk) = 5.0*zgco(jk)**2.0
                   omegao3(jk) = 7.0*zgco(jk)**3.0
                  endif
! -----------------------------------ZWJ-----------------------------------------------
! -------------------------------------------------------------------------------------                  
...
! ---------------------------ZWJ-------------------------------------------------------------
                   ...
                   zf = zgco(jk)**4.0
                   zwf = zomco(jk) * zf
                   ztauo(jk) = (1.0_r8 - zwf) * ztauo(jk)
                   zomco(jk) = (zomco(jk) - zwf) / (1.0_r8 - zwf)
                   omegao1(jk) = 3.0*(zgco(jk)-zf)/(1.0_r8-zf)
                   omegao2(jk) = 5.0*(zgco(jk)**2.0-zf)/(1.0_r8-zf)
                   omegao3(jk) = 7.0*(zgco(jk)**3.0-zf)/(1.0_r8-zf)
                   zgco (jk) = (zgco(jk) - zf) / (1.0_r8 - zf)
                  endif
! ---------------------------ZWJ-------------------------------------------------------------
! -------------------------------------------------------------------------------------------
