...
! -------------------------------------ZWJ----------------------------------
      subroutine rrtmg_sw &
            (lchnk   ,ncol    ,nlay    ,icld    ,          &
             ...
             swuflx  ,swdflx  ,swhr    ,swuflxc ,swdflxc ,swhrc, &
             dirdnuv, dirdnir, difdnuv, difdnir, ninflx, ninflxc, &
             swuflxs, swdflxs, omega2mcl, omega3mcl)
! -------------------------------------ZWJ----------------------------------
! --------------------------------------------------------------------------
...
! ----------------------------------------------------------------------------
! --------------------------------------ZWJ-----------------------------------
      real(kind=r8), intent(in) :: omega2mcl(:,:,:)
      real(kind=r8), intent(in) :: omega3mcl(:,:,:)
! --------------------------------------ZWJ-----------------------------------
! ----------------------------------------------------------------------------
! ----- Output -----
...
! -------------------------------------------------------------------------------
! -----------------------------------------ZWJ-----------------------------------
      real(kind=r8) :: omega2mc(ngptsw,nlay)
      real(kind=r8) :: omega3mc(ngptsw,nlay)
! -----------------------------------------ZWJ-----------------------------------
! -------------------------------------------------------------------------------
...
! -------------------------------------------------------------------------------
! ----------------------------------------ZWJ------------------------------------
      real(kind=r8) :: zfsfcmc(nlay,ngptsw)
      real(kind=r8) :: zomega2mc(nlay,ngptsw)  
      real(kind=r8) :: zomega3mc(nlay,ngptsw) 
! ----------------------------------------ZWJ------------------------------------
! -------------------------------------------------------------------------------
...
! -------------------------------ZWJ---------------------------
         call inatm_sw (iplon, nlay, icld, iaer, &
              ...
              adjflux, inflag, iceflag, liqflag, cldfmc, taucmc, &
              ssacmc, asmcmc, fsfcmc, ciwpmc, clwpmc, reicmc, dgesmc, relqmc, &
              taua, ssaa, asma, omega2mcl, omega3mcl, omega2mc, omega3mc)
! -------------------------------ZWJ---------------------------
! -------------------------------------------------------------
...
! --------------------------------------------------
! ------------------------ZWJ-----------------------
                  zomega2mc(i,ig) = omega2mc(ig,i)
                  zomega3mc(i,ig) = omega3mc(ig,i)
                  zfsfcmc(i,ig) = fsfcmc(ig,i)
! ------------------------ZWJ-----------------------
! --------------------------------------------------
               enddo
            enddo
...
! ------------------------------------------------------
! ---------------------------ZWJ------------------------
      real(kind=r8), intent(out) :: omega2mc(:,:)
      real(kind=r8), intent(out) :: omega3mc(:,:)
! ---------------------------ZWJ------------------------
! ------------------------------------------------------
! ----- Local -----
...
! --------------------------------------------------------------
! -------------------------------ZWJ----------------------------
               omega2mc(ig,l) = omega2mcl(ig,iplon,nlay-l)
               omega3mc(ig,l) = omega3mcl(ig,iplon,nlay-l)
! -------------------------------ZWJ----------------------------
! --------------------------------------------------------------
            enddo
...
! -----------------------------------------------------
! ---------------------------ZWJ-----------------------
         omega2mc(:,nlay) = 0.0_r8
         omega3mc(:,nlay) = 0.0_r8
! ---------------------------ZWJ-----------------------
! -----------------------------------------------------     
      endif
