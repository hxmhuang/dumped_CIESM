...
! qinyi
    call pbuf_add_field('lengi',     'global', dtype_r8, (/pcols, pverp/), lengi_idx) 
    call pbuf_add_field('shi',       'global', dtype_r8, (/pcols, pverp/), shi_idx) 
    call pbuf_add_field('smi',       'global', dtype_r8, (/pcols, pverp/), smi_idx) 
    call pbuf_add_field('wstarPBL',  'global', dtype_r8, (/pcols/),        wstar_idx) 
   ...
   if (masterproc) write(iulog, fmt='(a,i3,5x,a,i3)') 'NTOP_EDDY  =', ntop_eddy, 'NBOT_EDDY  =', nbot_eddy
    ...
    if (do_waccm_phys()) then
     ...
     if (is_first_step()) then
        ...
        ! qinyi: pay attention this, their initial data from ncdata file.
        ! 2017-09-01 22:40:44
        ...
        ! qinyi 2017-09-01 23:01:29
        call pbuf_set_field(pbuf2d, lengi_idx,    0.0_r8)
        call pbuf_set_field(pbuf2d, shi_idx,      0.0_r8)
        call pbuf_set_field(pbuf2d, smi_idx,      0.0_r8)
        call pbuf_set_field(pbuf2d, wstar_idx,    0.0_r8)
