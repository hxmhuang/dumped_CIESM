...
! qinyi
  ...
  ! qinyi 2017-11-30 21:39:46
  call pbuf_add_field('explwi2qtu','global',dtype_r8,(/pcols,pver/),explwi2qtu_idx)
  ! qinyi
...
! qinyi
      call compute_uwshcu_inv( pcols     , pver    , ncol           , pcnst         , ztodt         ,                   &
                               ...
                               qtu_shal, thlu_shal, & ! qinyi 
                               explwi2qtu) ! qinyi 2017-11-30 21:41:47
umf_shal = cmfmc2
