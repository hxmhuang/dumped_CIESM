...
my $CFIO_USED    = $xmlvars{'CFIO_USED'};
my $CFIO_ATMIO_NUM  = $xmlvars{'CFIO_ATMIO_NUM'};
my $CFIO_LNDIO_NUM  = $xmlvars{'CFIO_LNDIO_NUM'};
my $CFIO_OCNIO_NUM  = $xmlvars{'CFIO_OCNIO_NUM'};
my $CFIO_ICEIO_NUM  = $xmlvars{'CFIO_ICEIO_NUM'};
my $CFIO_GLCIO_NUM  = $xmlvars{'CFIO_GLCIO_NUM'};
my $CFIO_ROFIO_NUM  = $xmlvars{'CFIO_ROFIO_NUM'};
my $CFIO_WAVIO_NUM  = $xmlvars{'CFIO_WAVIO_NUM'};
...
if($CFIO_USED eq "TRUE") { 
    $tottasks += $CFIO_ATMIO_NUM;  
    $tottasks += $CFIO_LNDIO_NUM;  
    $tottasks += $CFIO_OCNIO_NUM;  
    $tottasks += $CFIO_ICEIO_NUM;  
    $tottasks += $CFIO_GLCIO_NUM;  
    $tottasks += $CFIO_ROFIO_NUM;  
    $tottasks += $CFIO_WAVIO_NUM;  
